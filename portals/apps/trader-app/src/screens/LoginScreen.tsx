...
export function LoginScreen() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-app-bg lg:overflow-hidden overflow-y-auto">
      {/* Mobile logo strip — full-width box at the very top, hidden on desktop */}
      {logoUrl && (
        <div className="lg:hidden w-full bg-app-bg px-6 py-4 flex items-center justify-center border-b border-border shadow-sm">
      ...
      {/* Identity & Branding */}
      <div className="lg:order-first w-full lg:w-[40%] flex flex-col justify-center px-8 lg:pl-36 lg:pr-6 py-12 lg:py-0 relative z-10 bg-app-bg lg:min-h-screen">
