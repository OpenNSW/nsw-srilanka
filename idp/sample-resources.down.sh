...
for c in \
    TRADER_PORTAL_APP \
    OGA_PORTAL_APP_NPQS OGA_PORTAL_APP_FCAU OGA_PORTAL_APP_CDA OGA_PORTAL_APP_SLPA OGA_PORTAL_APP_CUSTOMS \
    NPQS_TO_NSW FCAU_TO_NSW CDA_TO_NSW SLPA_TO_NSW CUSTOMS_TO_NSW \
    NSW_TO_NPQS NSW_TO_FCAU NSW_TO_CDA NSW_TO_SLPA NSW_TO_CUSTOMS; do
...
for u in suresh ramesh gomesh naresh \
         npqs_officer fcau_officer cda_officer slpa_officer customs_officer; do
    delete_user "$u"
done
