...
log_info "Government Organization OU path: government-organization (children: npqs, fcau, cda, slpa, customs)"
...
log_info "Government officers: npqs_officer, fcau_officer, cda_officer, slpa_officer, customs_officer - all in OGA Reviewers group"
log_info "SPA client IDs: TRADER_PORTAL_APP, OGA_PORTAL_APP_NPQS, OGA_PORTAL_APP_FCAU, OGA_PORTAL_APP_CDA, OGA_PORTAL_APP_SLPA, OGA_PORTAL_APP_CUSTOMS"
log_info "M2M client IDs (OGA -> NSW): NPQS_TO_NSW, FCAU_TO_NSW, CDA_TO_NSW, SLPA_TO_NSW, CUSTOMS_TO_NSW"
log_info "M2M client IDs (NSW -> OGA): NSW_TO_NPQS, NSW_TO_FCAU, NSW_TO_CDA, NSW_TO_SLPA, NSW_TO_CUSTOMS"
