...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS idx_consignments_reference_number ON consignments (reference_number);
...
-- @DOWN
DROP INDEX CONCURRENTLY IF NOT EXISTS idx_consignments_reference_number;
